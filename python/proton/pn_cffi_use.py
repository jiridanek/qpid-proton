# import os
# os.environ['LD_LIBRARY_PATH'] = os.environ.get('LD_LIBRARY_PATH', "") + ":/home/jdanek/repos/qpid/qpid-proton/build/install/lib64"

import _proton
# import _cffi_backend

a = _proton.lib.pn_message()
print(_proton.lib.pn_message_is_durable(a))
_proton.lib.pn_message_set_durable(a, True)
print(_proton.lib.pn_message_is_durable(a))
print(dir(a))
